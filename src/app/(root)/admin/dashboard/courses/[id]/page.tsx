          ...
          >
            <div className="flex items-center gap-4">
              ...
              <input
                ...
                placeholder={"Current: " + courseData?.name}
              />
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <input
                ...
                className="bg-gray w-full p-2 rounded"
                placeholder={"Current: " + courseData?.class_code}
              />
            </div>
            <div className="flex items-center gap-4">
              <label className="text-lg min-w-[150px] md:min-w-[200px]">
              ...
              <input
                ...
                className="bg-gray w-full p-2 rounded"
                placeholder={"Current: " + courseData?.course_code}
              />
            </div>
            <div className="flex items-center gap-4">
              <label className="text-lg min-w-[150px] md:min-w-[200px]">
              ...
              <input
                ...
                className="bg-gray w-full p-2 rounded"
                placeholder={"Current: " + courseData?.instructor}
              />
            </div>
            <div className="flex items-center gap-4">
              <label className="text-lg min-w-[150px] md:min-w-[200px]">
              ...
              >
                <option value="">Select academic year, current: {courseData?.academic_year}</option>
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <option value="">Select degree, current: {courseData?.degree}</option>
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <option value="">Select department, current: {courseData?.department}</option>
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <option value="">Select semester, current: {courseData?.semester}</option>
