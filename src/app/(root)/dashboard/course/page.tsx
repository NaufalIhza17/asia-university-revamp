    ...
    <section>
      ...
      <div className="flex flex-col mt-8">
        <table className="table-auto border border-gray-300 rounded-lg">
          <tbody>
            <tr>
              <td className="text-left pl-4 pr-4 py-2 border border-gray-300 text-[#123E44] bg-white" style={{ width: "50%" }}>
              ...
              <td className="text-left pl-4 pr-4 py-2 border border-gray-300 text-[#123E44] bg-white" style={{ width: "50%" }}>
                <span style={{ marginRight: "10px" }}>Semester</span>
                <select className="border border-gray-300 rounded-md px-2 py-1 bg-white">
            ...
            <tr>
              <td className="text-left pl-4 pr-4 py-2 border border-gray-300 text-[#123E44] bg-[#F0F0F0]" style={{ width: "50%" }}>
            ...
            <tr>
              <td className="text-left pl-4 pr-4 py-2 border border-gray-300 text-[#123E44] bg-white" style={{ width: "10%" }}>
                <span style={{ marginRight: "10px" }}>Department</span>

              </td>
              <td className="text-left pl-4 pr-4 py-2 border border-gray-300 text-[#123E44] bg-white" style={{ width: "90%" }}>
                <span style={{ marginRight: "5px" }}></span>
                <select className="border border-gray-300 rounded-md px-2 py-1 bg-white">
                  <option value="Computer Science & Information Engineering">Department of Computer Science & Information Engineering</option>
                  <option value="Psychology">Department of Psychology (College of Medical and Health Science)</option>
                  <option value="Business Administration">Department of Business Administration (Asia Management College)</option>
                  <option value="Foreign Languages and Literature">Department of Foreign Languages and Literature (College of Humanities and Social Sciences)</option>
                  <option value="Digital Media Design">Department of Digital Media Design (College of Creative Design)</option>
                  <option value="Visual Communication Design">Department of Visual Communication Design (College of Creative Design)</option>
                  <option value="Financial and Economic Law">Department of Financial and Economic Law (Asia Management College)</option>
                </select>
              </td>
            </tr>
            <tr>
              <td className="text-left pl-4 pr-4 py-2 border border-gray-300 text-[#123E44] bg-[#F0F0F0]" style={{ width: "50%" }}>
                <span style={{ marginRight: "10px" }}>Course Code</span>
                <select className="border border-gray-300 rounded-md px-2 py-1 bg-white">
              ...
              <td className="text-left pl-4 pr-4 py-2 border border-gray-300 text-[#123E44] bg-[#F0F0F0]" style={{ width: "50%" }}>
                ...
                <select className="border border-gray-300 rounded-md px-2 py-1 bg-white">
                  ...
                  <option value="Microprocessor and Embedded Systems">Microprocessor and Embedded Systems</option>
            ...
            <tr>
              <td className="text-left pl-4 pr-4 py-2 border border-gray-300 text-[#123E44] bg-white" style={{ width: "50%" }}>
                <span style={{ marginRight: "10px" }}>Instructor</span>
                <select className="border border-gray-300 rounded-md px-2 py-1 bg-white">
              ...
              <td className="text-left pl-4 pr-4 py-2 border border-gray-300 text-[#123E44] bg-white" style={{ width: "50%" }}>
                <span style={{ marginRight: "10px" }}>Classroom No</span>
                <select className="border border-gray-300 rounded-md px-2 py-1 bg-white">
            ...
            <tr>
              <td className="text-left pl-4 pr-4 py-2 border border-gray-300 text-[#123E44] bg-[#F0F0F0]" style={{ width: "50%" }}>
                <span style={{ marginRight: "10px" }}>Required / Elective</span>
                <select className="border border-gray-300 rounded-md px-2 py-1 bg-white">
            ...
            <tr>
              ...
              <td className="text-left pl-4 pr-4 py-2 border border-gray-300 text-[#123E44]  bg-white" style={{ width: "50%" }}>
                ...
                <span style={{ margin: "0 5px" }}>end</span>
                <select className="border border-gray-300 rounded-md px-2 py-1 bg-white">
                  <option value="All">All</option>
                  <option value="1">1</option>
                  <option value="2">2</option>
        ...
        <button className="flex items-center rounded-full bg-[#2D937C] text-white font-bold px-6 py-2 hover:bg-[#1D6F58] transition-colors duration-300" style={{ marginRight: "10px" }}>
