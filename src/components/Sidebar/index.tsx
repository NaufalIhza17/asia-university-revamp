        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              {/* <li>
                <Link
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark ${
                    pathname === "/admin/dashboard" && "bg-graydark"
                  }`}
                >
                  <svg
              ...
              <li>
                <Link
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark ${
                    pathname.includes("students") && "bg-graydark"
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <Link
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark ${
                    pathname.includes("courses") && "bg-graydark"
                  }`}
                >
                  <svg
                    width="18"
              ...
              <li>
                <Link
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark ${
                    pathname.includes("payments") && "bg-graydark"
                  }`}
                >
                  <svg
                    fill="none"
                  ...
                  >
                    ...
                    <g id="SVGRepo_iconCarrier">
                      ...
                      <g>
                        ...
                        <g>
                          {" "}
                          <path d="M152.383,330.883H91.429c-10.099,0-18.286,8.187-18.286,18.286c0,10.099,8.187,18.286,18.286,18.286h60.954 c10.099,0,18.286-8.187,18.286-18.286C170.668,339.07,162.481,330.883,152.383,330.883z"></path>{" "}
                        </g>{" "}
                      </g>{" "}
                    </g>
                  </svg>
              ...
              <li>
                <Link
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark ${
                    pathname.includes("news") && "bg-graydark"
                  }`}
                >
                  <svg
                    className="fill-current"
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              <li>
                <button
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark w-full ${
                    pathname.includes("logout") && "bg-graydark"
                  }`}
                  onClick={() => {
                    Cookies.remove("ACCESS_TOKEN");
                    Cookies.remove("REFRESH_TOKEN");
